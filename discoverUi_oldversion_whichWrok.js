    ...
    function flushQueue(queueId, sync) {
        var queue = queueManager.get(queueId),
            ...
            httpHeaders = {
                ...
                "X-Discover": "device (UIC) Lib/12.1.2",
                "X-DiscoverType": "GUI",
                ...
                for (i = 0, len = sourceIframeList.length; i < len; i += 1) {
                    try {
                        ...
                        if (iframeWindow && iframeWindow.document && iframeWindow.location.href !== "about:blank") {
                            ...
                            // Set the dcxid for this frame in the target DOM
                            targetIframeList[i].setAttribute("dcxid", iframeID);
                            iframeCapture.dcxid = iframeID;
    ...
    DCX.init({
        ...
        services: {
            queue: {
				...
				// previous endpoints "https://unidiscover-packet-fwdr.sbx0089.play.products.pnpsofy.com/DiscoverUIPost.php",
				//  https://unidiscover-packet-fwdr.35.184.56.255.nip.io/DiscoverUIPost.php
				// "https://10.115.147.14/DiscoverUIPost.php"
				// "https://sky.discoverstore.hclcx.com/DiscoverUIPost.php"
