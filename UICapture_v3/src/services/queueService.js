...
/*jshint devel:true */
                        ...
                        // Callback function to check if screenview is blocked
                        DCX.registerBridgeCallbacks([{
                            enabled: true, // enabled true
                            cbType: "messageRedirect",
                            cbFunction: function (msg, msgObj) {
                                // Get screenviewPath from msgObj.screenViewPath
                                var screenviewPath = (msgObj && msgObj.screenViewPath);
                                // Check if screenview is blocked
                                if (DCX.isScreenviewBlockList(screenviewPath)) {
    ...
    function flushQueue(queueId, sync) {
        var queue = queueManager.get(queueId),
            ...
            httpHeaders = {
                ...
                "X-Discover": "device (UIC) Lib/DCXLIB_TOKEN_VERSION",
                "X-DiscoverType": "GUI",
