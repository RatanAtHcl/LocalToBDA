...
public class DOM_Diff_iframe extends UICInit {
    ...
    public DOM_Diff_iframe(final String browser) {
        super(browser, "DOM_Diff_iframe", "index.html", "ai", null, true);
    ...
    @Test
    public void ifr1_nestedInputsDiffsAreBeingCapturedCorrectly() throws Exception {
    	...
    	final JSONObject c = getUICObject("[[\"iframe\"],[\"addChildInputsBtn1\"]]");
        ...
        if(!xpath1.equals("[[\"iframe\"],[\"container_1.target.td\"]]")) {
        	t.addMsg("xpath", "[[\"iframe\"],[\"container_1.target.td\"]]", xpath1);
        }
        
        String xpath2 = diff2.getString("xpath");
        if(!xpath2.equals("[[\"iframe\"],[\"container_2.target.td\"]]")) {
        	t.addMsg("xpath", "[[\"iframe\"],[\"container_2.target.td\"]]", xpath2);
        }
        ...
        String dcid1 = getUICObject("[[\"iframe\"],[\"html\",0],[\"body\",0],[\"input\",0]]").getString("dcid");
    ...
    @Test
    public void ifr2_attributeDiffsAreBeingCapturedCorrectly() throws Exception {
    	
    	final UICTest t = new UICTest("ifr2_attributeDiffsAreBeingCapturedCorrectly", browser);
        ...
        String xpath1 = diff1.getString("xpath");
        if(!xpath1.equals("[[\"iframe\"],[\"cb1\"]]")) {
        	t.addMsg("xpath1", "[[\"iframe\"],[\"cb1\"]]", xpath1);
        }
        ...
        String xpath2 = diff2.getString("xpath");
        if(!xpath2.equals("[[\"iframe\"],[\"cb2\"]]")) {
        	t.addMsg("xpath2", "[[\"iframe\"],[\"cb2\"]]", xpath2);
        }
        ...
        if(!xpath3.equals("[[\"iframe\"],[\"cb3\"]]")) {
        	t.addMsg("xpath3", "[[\"iframe\"],[\"cb3\"]]", xpath3);
        }
        ...
        if(!xpath4.equals("[[\"iframe\"],[\"foo_priv\"]]")) {
        	t.addMsg("xpath4", "[[\"iframe\"],[\"foo_priv\"]]", xpath4);
        }
    ...
    @Test
    public void ifr3_elementsAddToATargetDevAreBeingCaptured() throws Exception {
    	
    	final UICTest t = new UICTest("ifr3_elementsAddToATargetDevAreBeingCaptured", browser);
    	...
    	final JSONObject c = getUICObject("[[\"iframe\"],[\"addDivBtn1\"]]");
    	assertNotNull("UIC," + browser + ",uicObject,NULL", c);
    	
    	final JSONObject uicObject = getUICObjectbymsgType("12");
    	assertNotNull("UIC," + browser + ",uicObject,NULL", uicObject);
    	System.out.println(uicObject);
        ...
        if(!xpath.equals("[[\"iframe\"],[\"html\",0],[\"body\",0],[\"div\",1]]")) {
        	t.addMsg("xpath", "[[\"iframe\"],[\"html\",0],[\"body\",0],[\"div\",1]]", xpath);
        }
    ...
    @Test
    public void ifr4_valuesEnteredWithinNestedInputsBeingCapturedCorrectly() throws Exception {
    	
    	final UICTest t = new UICTest("ifr4_valuesEnteredWithinNestedInputsBeingCapturedCorrectly", browser);
        ...
        final JSONObject v = (JSONObject) getUICObject("[[\"iframe\"],[\"container_1.target.td\"],[\"input\",0]]");
    ...
    @Test
    public void ifr5_valuesEnteredWithinATargetDivAreBeingCaptured() throws Exception {
    	
    	final UICTest t = new UICTest("ifr5_valuesEnteredWithinATargetDivAreBeingCaptured", browser);
        ...
        JSONObject event = getUICObject("[[\"iframe\"],[\"ip-x-1\"]]");
        ...
        event = getUICObject("[[\"iframe\"],[\"ip-x-2\"]]");
        ...
        event = getUICObject("[[\"iframe\"],[\"ip-x-3\"]]");
        ...
        event = getUICObject("[[\"iframe\"],[\"select.pvt\"]]");
        ...
        event = getUICObject("[[\"iframe\"],[\"ip.radio2\"]]");
        ...
        event = getUICObject("[[\"iframe\"],[\"txtarea.pvt\"]]");
    ...
    public void fr6_DOMcapturesTriggeredByCustomUIEvents() throws Exception {
    	...
    	final JSONObject uicObject = getUICObjectByEventType("[[\"CustomEvent\"],[\"submitbtn\"]]", "Login");
