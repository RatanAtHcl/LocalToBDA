...
public class DOM_Diff_Extra_1 extends UICInit {
    ...
    public DOM_Diff_Extra_1(final String browser) {
        super(browser, "DOM_Diff_Extra", "index1.html", "addDivBtn", null, true);
    ...
    //This test is not working - issues with the DOM Capture configuration
    //Check with the timing to fix the issue
    @Test
    public void testOne() throws Exception {
    	...
    	wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("pi")));
    	
    	driver.findElement(By.id("pi")).clear();
    	
    	assertTrue(isElementPresent(By.className("domcapture")));
    	final WebElement e1 = driver.findElement(By.className("domcapture"));
    	e1.click();
