...
<?php
     ...
     */
    $DCX_TARGET_VERSION = "12.1.10";
    $DCX_TARGET_RESP_CONTENT_TYPE = "text/plain";
    /*
     * NOTE: Update the DCX_MAX_REQ_LENGTH setting to reflect the typical POST data size specific to your deployment.
     */
    $DCX_MAX_REQ_LENGTH = 20000;

    header("Content-Type: ".$DCX_TARGET_RESP_CONTENT_TYPE);
...
<body>
<?php
      echo "<p>Discover Target Version $DCX_TARGET_VERSION</p>";
      echo ProcessPost();
?>
</body>
</html>
