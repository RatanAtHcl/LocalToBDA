    ...
    function flushQueue(queueId, sync) {
        var data = queueManager.flush(queueId),
            ...
            httpHeaders = {
                ...
                "X-Discover": "device (UIC) Lib/5.0.0.1707",
                        ...
                        if (sizzleURL) {
                            message = {
                                ...
                                oncomplete: function (result) {
                                    ...
                                    define.amd = true;
                                    // AppScan: To disable use of eval DO NOT set the "sizzleURL" property in the
                                    // browser service configuration. Refer to the documentation for details.
...
DCX.addModule("replay", function (context) {
    ...
    function getClientStateMessage(webEvent) {
        ...
        scaleWidth = !msg.clientState.viewPortWidth ? 1 : (normalizedScreenWidth / msg.clientState.viewPortWidth);
        msg.clientState.deviceScale = scaleWidth.toFixed(3);
