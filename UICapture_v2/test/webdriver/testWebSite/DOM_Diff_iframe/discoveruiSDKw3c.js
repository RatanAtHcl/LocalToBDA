    ...
    function flushQueue(queueId, sync) {
        var data = queueManager.flush(queueId),
            ...
            httpHeaders = {
                ...
                "X-Discover": "device (UIC) Lib/5.2.0.1768",
                "X-DiscoverType": "GUI",
...
DCX.init({
  "services": {
    ...
    "queue": {
      "queues": [
        {
          "qid": "DEFAULT",
          "endpoint": "http://50.23.117.121:9080/collector/collectorPost",
          "maxEvents": 25,
          "maxSize": 0,
          "timerinterval": 0,
		  "checkEndpoint": false,
          "endpointCheckTimeout": 50000,
          "encoder": "gzip"
        }
      ],
  ...
  "modules": {
	...
	//"dcAppKey": "b03c29a4693b4a68b2c453ea1569d940",
