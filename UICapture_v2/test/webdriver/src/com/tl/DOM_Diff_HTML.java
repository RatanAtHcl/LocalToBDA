...
public class DOM_Diff_HTML extends UICInit {
    ...
    public DOM_Diff_HTML(final String browser) {
        super(browser, "DOM_Diff_HTML", "index.html", "addDivBtn", null, true);
    ...
    @Test
    public void s1_attributeDiffsAreBeingCapturedCorrectly() throws Exception{
    	
    	final UICTest t = new UICTest("s1_attributeDiffsAreBeingCapturedCorrectly", browser);
        ...
        if(!diffs.getString("dcid").contains("dcid-2")) {
        	t.addMsg("dcid", "dcid-2", diffs.getString("dcid"));
        }
        ...
        if(!xpath1.equals("[[\"cb1\"]]")) {
        	t.addMsg("xpath1", "[[\"cb1\"]]", xpath1);
        }
        ...
        if(!xpath2.equals("[[\"cb2\"]]")) {
        	t.addMsg("xpath2", "[[\"cb2\"]]", xpath2);
        }
        ...
        if(!xpath3.equals("[[\"cb3\"]]")) {
        	t.addMsg("xpath3", "[[\"cb3\"]]", xpath3);
        }
        ...
        if(!xpath4.equals("[[\"foo_priv\"]]")) {
        	t.addMsg("xpath4", "[[\"foo_priv\"]]", xpath4);
        }
        ...
        String dcid1 = getUICObject("[[\"html\",0],[\"body\",0],[\"input\",0]]").getString("dcid");
    ...
    @Test
    public void s2_nestedInputsDiffsAreBeingCapturedCorrectly() throws Exception {
    	
    	final UICTest t = new UICTest("s2_nestedInputsDiffsAreBeingCapturedCorrectly", browser);
    	...
    	final JSONObject c = getUICObject("addChildInputsBtn1");
        ...
        String xpath1 = diff1.getString("xpath");
        if(!xpath1.equals("[[\"container_1.target.td\"]]")) {
        	t.addMsg("xpath", "[[\"container_1.target.td\"]]", xpath1);
        }
        
        String xpath2 = diff2.getString("xpath");
        if(!xpath2.equals("[[\"container_2.target.td\"]]")) {
        	t.addMsg("xpath", "[[\"container_2.target.td\"]]", xpath2);
        }
    ...
    @Test
    public void s3_elementsAddToATargetDevAreBeingCaptured() throws Exception {
    	
    	final UICTest t = new UICTest("s3_elementsAddToATargetDevAreBeingCaptured", browser);
    	...
    	final JSONObject c = getUICObject("addDivBtn1");
    	assertNotNull("UIC," + browser + ",uicObject,NULL", c);
        ...
        if(!xpath.equals("[[\"html\",0],[\"body\",0],[\"div\",1]]")) {
        	t.addMsg("xpath", "[[\"html\",0],[\"body\",0],[\"div\",1]]", xpath);
        }
    ...
    @Test
    public void s4_valuesEnteredWithinNestedInputsBeingCapturedCorrectly() throws Exception {
    	
    	final UICTest t = new UICTest("s4_valuesEnteredWithinNestedInputsBeingCapturedCorrectly", browser);
        ...
        final JSONObject v = (JSONObject) getUICObject("[[\"container_1.target.td\"],[\"input\",0]]");
    ...
    @Test
    public void s5_valuesEnteredWithinATargetDivAreBeingCaptured() throws Exception {
    	
    	final UICTest t = new UICTest("s5_valuesEnteredWithinATargetDivAreBeingCaptured", browser);
        ...
        JSONObject event = getUICObject("ip-x-1");
        ...
        event = getUICObject("txtarea.pvt");
        ...
        final JSONObject obj = (JSONObject) getUICObjectbymsgType("12");
